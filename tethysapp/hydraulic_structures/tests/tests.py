...
# from ..app import HydraulicStructures
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.hydraulic_structures"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.hydraulic_structures.tests.tests"

        To run tests in the HydraulicStructuresTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.hydraulic_structures.tests.tests.HydraulicStructuresTestCase"

        To run only the test_if_tethys_platform_is_great function in the HydraulicStructuresTestCase class:
            Test command: "tethys test -f
            tethys_apps.tethysapp.hydraulic_structures.tests.tests.HydraulicStructuresTestCase.test_if_tethys_platform_is_great"
...
class HydraulicStructuresTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(HydraulicStructures)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(HydraulicStructures)
