...
class ManagePresasYEmbalsesResources(ManageResources, FileCollectionsControllerMixin):
    """
    ...
    def get_launch_url(self, request, resource):
        ...
        """
        return reverse('hydraulic_structures:presas_y_embalses_details_tab', args=[resource.id, 'summary'])
