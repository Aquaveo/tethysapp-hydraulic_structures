...
class ManageHydraulicInfrastructureResources(ManageResources, FileCollectionsControllerMixin):
    """
    Controller for manage_resources page.
    """

    template_name = "hydraulic_structures/resources/manage_hydraulic_infrastructure_resource.html"
    ...
    def _handle_get(self, request, *args, **kwargs):
        ...
        hydraulic_structure_types = dict()
        for key, value in HYDRAULIC_INFRASTRUCTURE_TYPE.items():
            hydraulic_structure_types[key] = value
        ...
        context.update(
            {
                ...
                "hydraulic_structure_types": hydraulic_structure_types,
            }
        )
    ...
    def get_launch_url(self, request, resource):
        ...
        """
        return reverse("hydraulic_structures:hydraulic_infrastructure_details_tab", args=[resource.id, "summary"])
